...
- `signif(x, digits = 6)`: Rounds the values in its first argument  (i.e., x) to the specified number of significant (= non-zero) digits
...
Hopefully, you see the differences. For most of your purposes, the `round()` function is the one we need. Let's give it a try! 
